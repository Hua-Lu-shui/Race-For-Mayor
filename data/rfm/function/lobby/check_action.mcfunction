...
execute positioned 62 -49 -22 unless entity @s[distance=..16] run scoreboard players set @s lobby_action 0
execute positioned 62 -49 -22 unless entity @s[distance=..16] run return 0
