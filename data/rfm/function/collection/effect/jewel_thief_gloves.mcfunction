...
execute if score @s collection_cap matches 3.. if score @s collection_slot3 matches 0 run scoreboard players set @s collection_effect_pick 1
execute if score @s collection_cap matches 4.. if score @s collection_slot4 matches 0 run scoreboard players set @s collection_effect_pick 1
execute if score @s collection_cap matches 5.. if score @s collection_slot5 matches 0 run scoreboard players set @s collection_effect_pick 1
execute unless score @s collection_effect_pick matches 1 run return 0
...
execute as @a[tag=rfm_participant,tag=!rfm_collection_thief,sort=random,limit=1] if score @s collection_slot1 matches 1.. unless score @s collection_slot1 = @a[tag=rfm_participant,tag=rfm_collection_thief,limit=1] collection_slot1 unless score @s collection_slot1 = @a[tag=rfm_participant,tag=rfm_collection_thief,limit=1] collection_slot2 unless score @s collection_slot1 = @a[tag=rfm_participant,tag=rfm_collection_thief,limit=1] collection_slot3 unless score @s collection_slot1 = @a[tag=rfm_participant,tag=rfm_collection_thief,limit=1] collection_slot4 unless score @s collection_slot1 = @a[tag=rfm_participant,tag=rfm_collection_thief,limit=1] collection_slot5 run tag @s add rfm_collection_victim
execute as @a[tag=rfm_participant,tag=!rfm_collection_thief,sort=random,limit=1] if score @s collection_slot2 matches 1.. unless score @s collection_slot2 = @a[tag=rfm_participant,tag=rfm_collection_thief,limit=1] collection_slot1 unless score @s collection_slot2 = @a[tag=rfm_participant,tag=rfm_collection_thief,limit=1] collection_slot2 unless score @s collection_slot2 = @a[tag=rfm_participant,tag=rfm_collection_thief,limit=1] collection_slot3 unless score @s collection_slot2 = @a[tag=rfm_participant,tag=rfm_collection_thief,limit=1] collection_slot4 unless score @s collection_slot2 = @a[tag=rfm_participant,tag=rfm_collection_thief,limit=1] collection_slot5 run tag @s add rfm_collection_victim
execute as @a[tag=rfm_participant,tag=!rfm_collection_thief,sort=random,limit=1] if score @s collection_slot3 matches 1.. unless score @s collection_slot3 = @a[tag=rfm_participant,tag=rfm_collection_thief,limit=1] collection_slot1 unless score @s collection_slot3 = @a[tag=rfm_participant,tag=rfm_collection_thief,limit=1] collection_slot2 unless score @s collection_slot3 = @a[tag=rfm_participant,tag=rfm_collection_thief,limit=1] collection_slot3 unless score @s collection_slot3 = @a[tag=rfm_participant,tag=rfm_collection_thief,limit=1] collection_slot4 unless score @s collection_slot3 = @a[tag=rfm_participant,tag=rfm_collection_thief,limit=1] collection_slot5 run tag @s add rfm_collection_victim
execute as @a[tag=rfm_participant,tag=!rfm_collection_thief,sort=random,limit=1] if score @s collection_slot4 matches 1.. unless score @s collection_slot4 = @a[tag=rfm_participant,tag=rfm_collection_thief,limit=1] collection_slot1 unless score @s collection_slot4 = @a[tag=rfm_participant,tag=rfm_collection_thief,limit=1] collection_slot2 unless score @s collection_slot4 = @a[tag=rfm_participant,tag=rfm_collection_thief,limit=1] collection_slot3 unless score @s collection_slot4 = @a[tag=rfm_participant,tag=rfm_collection_thief,limit=1] collection_slot4 unless score @s collection_slot4 = @a[tag=rfm_participant,tag=rfm_collection_thief,limit=1] collection_slot5 run tag @s add rfm_collection_victim
