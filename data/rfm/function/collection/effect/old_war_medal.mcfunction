...
execute unless score @s collection_slot1 matches 6 unless score @s collection_slot2 matches 6 run return 0
...
execute if score @s collection_effect_pick matches 1 run tellraw @s [{"text":"【老旧的战功章】","color":"#FFA500","bold":true},{"text":"你完美完成了行动任务，最低属性 +5。","color":"white"}]
