...
execute if score @s collection_lowest matches 1 run tellraw @s [{"text":"【万能钥匙】","color":"light_purple","bold":true},{"text":"本回合开始，最低属性名誉翻倍。","color":"white"}]
execute if score @s collection_lowest matches 2 run tellraw @s [{"text":"【万能钥匙】","color":"light_purple","bold":true},{"text":"本回合开始，最低属性经济翻倍。","color":"white"}]
execute if score @s collection_lowest matches 3 run tellraw @s [{"text":"【万能钥匙】","color":"light_purple","bold":true},{"text":"本回合开始，最低属性民生翻倍。","color":"white"}]
execute if score @s collection_lowest matches 4 run tellraw @s [{"text":"【万能钥匙】","color":"light_purple","bold":true},{"text":"本回合开始，最低属性生态翻倍。","color":"white"}]
