...
execute unless score @s collection_slot1 matches 5 unless score @s collection_slot2 matches 5 unless score @s collection_slot3 matches 5 run return 0
...
tellraw @s [{"text":"【诉讼卷宗】","color":"green","bold":true},{"text":"你使用了一枚令牌，所有属性 +5。","color":"white"}]
