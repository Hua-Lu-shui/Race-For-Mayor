#“水晶球”：回合开始时，最高权重对应的属性+3；并列最高时随机选择其中一项
...
execute if score @s collection_effect_pick matches 1 run tellraw @s [{"text":"【水晶球】","color":"light_purple","bold":true},{"text":"本回合名誉权重最高，名誉 +3。","color":"white"}]
execute if score @s collection_effect_pick matches 2 run tellraw @s [{"text":"【水晶球】","color":"light_purple","bold":true},{"text":"本回合经济权重最高，经济 +3。","color":"white"}]
execute if score @s collection_effect_pick matches 3 run tellraw @s [{"text":"【水晶球】","color":"light_purple","bold":true},{"text":"本回合民生权重最高，民生 +3。","color":"white"}]
execute if score @s collection_effect_pick matches 4 run tellraw @s [{"text":"【水晶球】","color":"light_purple","bold":true},{"text":"本回合生态权重最高，生态 +3。","color":"white"}]
