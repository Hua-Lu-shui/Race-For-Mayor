...
execute if score @s fame = @s collection_highest run scoreboard players add @s collection_effect_mask 1
execute if score @s economy = @s collection_highest run scoreboard players add @s collection_effect_mask 2
execute if score @s welfare = @s collection_highest run scoreboard players add @s collection_effect_mask 4
execute if score @s ecology = @s collection_highest run scoreboard players add @s collection_effect_mask 8
