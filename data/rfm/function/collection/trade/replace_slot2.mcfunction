...
execute unless score #confirm_valid collection_target matches 1 run return run tellraw @s {"text":"请留在自己的办公室并靠近神秘人完成交易。","color":"red"}
...
scoreboard players set @s collection_target 2
