...
execute unless score @s collection_attr matches 1..4 unless score @s collection_attr matches 6..8 run return run tellraw @s {"text":"藏品交易属性配置无效，交易已取消。","color":"red"}
...
execute if score @s collection_attr matches 7 if score @s collection_highest = @s collection_lowest run scoreboard players operation @s collection_effect_value += @s collection_cost
execute if score @s collection_attr matches 7 if score @s collection_highest = @s collection_lowest if score @s collection_highest matches 1 unless score @s fame >= @s collection_effect_value run return run tellraw @s {"text":"名誉不足，无法完成交易。","color":"red"}
execute if score @s collection_attr matches 7 if score @s collection_highest = @s collection_lowest if score @s collection_highest matches 2 unless score @s economy >= @s collection_effect_value run return run tellraw @s {"text":"经济不足，无法完成交易。","color":"red"}
execute if score @s collection_attr matches 7 if score @s collection_highest = @s collection_lowest if score @s collection_highest matches 3 unless score @s welfare >= @s collection_effect_value run return run tellraw @s {"text":"民生不足，无法完成交易。","color":"red"}
execute if score @s collection_attr matches 7 if score @s collection_highest = @s collection_lowest if score @s collection_highest matches 4 unless score @s ecology >= @s collection_effect_value run return run tellraw @s {"text":"生态不足，无法完成交易。","color":"red"}
execute if score @s collection_attr matches 7 if score @s collection_highest matches 1 unless score @s fame >= @s collection_cost run return run tellraw @s {"text":"名誉不足，无法完成交易。","color":"red"}
execute if score @s collection_attr matches 7 if score @s collection_highest matches 2 unless score @s economy >= @s collection_cost run return run tellraw @s {"text":"经济不足，无法完成交易。","color":"red"}
execute if score @s collection_attr matches 7 if score @s collection_highest matches 3 unless score @s welfare >= @s collection_cost run return run tellraw @s {"text":"民生不足，无法完成交易。","color":"red"}
execute if score @s collection_attr matches 7 if score @s collection_highest matches 4 unless score @s ecology >= @s collection_cost run return run tellraw @s {"text":"生态不足，无法完成交易。","color":"red"}
execute if score @s collection_attr matches 7..8 if score @s collection_lowest matches 1 unless score @s fame >= @s collection_cost run return run tellraw @s {"text":"名誉不足，无法完成交易。","color":"red"}
execute if score @s collection_attr matches 7..8 if score @s collection_lowest matches 2 unless score @s economy >= @s collection_cost run return run tellraw @s {"text":"经济不足，无法完成交易。","color":"red"}
execute if score @s collection_attr matches 7..8 if score @s collection_lowest matches 3 unless score @s welfare >= @s collection_cost run return run tellraw @s {"text":"民生不足，无法完成交易。","color":"red"}
execute if score @s collection_attr matches 7..8 if score @s collection_lowest matches 4 unless score @s ecology >= @s collection_cost run return run tellraw @s {"text":"生态不足，无法完成交易。","color":"red"}
