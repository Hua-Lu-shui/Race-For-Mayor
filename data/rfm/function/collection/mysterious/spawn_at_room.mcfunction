...
execute if score @s room matches 1 run data merge entity @e[type=minecraft:item_display,tag=rfm_collection_new,sort=nearest,limit=1,distance=..1] {Rotation:[0.0f,0.0f]}
...
execute if score @s room matches 7 run data merge entity @e[type=minecraft:item_display,tag=rfm_collection_new,sort=nearest,limit=1,distance=..1] {Rotation:[180.0f,0.0f]}
