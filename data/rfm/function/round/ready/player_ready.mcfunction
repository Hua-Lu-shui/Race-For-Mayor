...
execute if score #round round matches 0 run tellraw @a [{"selector":"@s","color":"white"},{"text":" 已准备好开始第一回合。","color":"gray"}]
execute if score #round round matches 1.. run tellraw @a [{"selector":"@s","color":"white"},{"text":" 已准备好进入下一回合。","color":"gray"}]
