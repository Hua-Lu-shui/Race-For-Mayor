...
execute as @a run function rfm:collection/effect/master_key
...
execute as @a run function rfm:collection/effect/unstable_device
...
execute as @a run function rfm:collection/effect/succulent
execute as @a run function rfm:collection/effect/paper_plane
execute as @a run function rfm:collection/effect/monocle
execute as @a run function rfm:collection/effect/horn
#提示当前回合数
