...
execute as @a if score @s welfare > #public_lead_welfare welfare run scoreboard players operation #public_lead_welfare welfare = @s welfare
execute as @a if score @s welfare = #public_lead_welfare welfare run tag @s add rfm_public_lead_welfare
