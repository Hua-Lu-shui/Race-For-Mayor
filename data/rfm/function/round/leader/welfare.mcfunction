...
execute if score #round round matches ..5 if entity @a[tag=rfm_participant,tag=rfm_public_lead_welfare] run tellraw @a[tag=rfm_participant] [{"text":"民生领先：","color":"red","bold":true},{"selector":"@a[tag=rfm_participant,tag=rfm_public_lead_welfare]","separator":{"text":"、","color":"gray"},"color":"white","bold":true}]
execute if score #round round matches ..5 unless entity @a[tag=rfm_participant,tag=rfm_public_lead_welfare] run tellraw @a[tag=rfm_participant] [{"text":"民生领先：","color":"red","bold":true},{"text":"无公开候选人","color":"gray"}]
execute if score #round round matches 6.. if score #reveal_welfare leader_reveal matches 1 if entity @a[tag=rfm_participant,tag=rfm_public_lead_welfare] run tellraw @a[tag=rfm_participant] [{"text":"民生领先：","color":"red","bold":true},{"selector":"@a[tag=rfm_participant,tag=rfm_public_lead_welfare]","separator":{"text":"、","color":"gray"},"color":"white","bold":true}]
execute if score #round round matches 6.. if score #reveal_welfare leader_reveal matches 1 unless entity @a[tag=rfm_participant,tag=rfm_public_lead_welfare] run tellraw @a[tag=rfm_participant] [{"text":"民生领先：","color":"red","bold":true},{"text":"无公开候选人","color":"gray"}]
execute if score #round round matches 6.. unless score #reveal_welfare leader_reveal matches 1 if entity @a[tag=rfm_participant,tag=rfm_public_lead_welfare] run tellraw @a[tag=rfm_participant] [{"text":"民生领先：","color":"red","bold":true},{"text":"?","color":"white","bold":true}]
