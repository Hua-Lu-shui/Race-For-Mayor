...
execute as @a if score @s fame > #public_lead_fame fame run scoreboard players operation #public_lead_fame fame = @s fame
execute as @a if score @s fame = #public_lead_fame fame run tag @s add rfm_public_lead_fame
