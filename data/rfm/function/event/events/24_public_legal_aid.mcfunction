...
title @a[tag=rfm_participant] title {"translate":"rfm.text.8097bc39d004","color":"light_purple","bold":true}
title @a[tag=rfm_participant] subtitle [{"translate":"rfm.text.c648a25366c9","color":"gray"},{"text":"+3","color":"green","bold":true}]
tellraw @a[tag=rfm_participant] {"translate":"rfm.text.d748710efd4b","color":"light_purple","bold":true}
tellraw @a[tag=rfm_participant] [{"translate":"rfm.text.dd46bd7444bb","color":"gold","bold":true},{"translate":"rfm.text.8ea8810db168","color":"white"}]
