...
tellraw @a {"text":"【城市事件】舆情榜单公开","color":"aqua","bold":true}
tellraw @a [{"text":"【事件背景】","color":"gold","bold":true},{"text":"市政研究机构开放候选人舆情追踪榜单，公众可以持续查看谁在城市声望方面领先。","color":"white"}]
tellraw @a [{"text":"【事件影响】","color":"yellow","bold":true},{"text":"本局剩余时间将永久显示名誉领先者。当前名誉领先：","color":"white"},{"selector":"@a[tag=rfm_lead_fame]","color":"aqua","bold":true}]
