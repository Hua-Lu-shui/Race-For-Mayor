...
execute unless score #round round matches 1 unless score #round round matches 3 unless score #round round matches 5 unless score #round round matches 7 unless score #round round matches 9 run function rfm:round/ready/next
