...
execute if score @s ability_trigger matches 1 run tellraw @s [{"text":"【富人思维】","color":"yellow","bold":true},{"text":"本回合开始时经济为最低属性，经济 +5。","color":"white"}]
