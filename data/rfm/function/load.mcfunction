...
setblock 35 -49 -15 minecraft:cherry_wall_sign[facing=east,waterlogged=false]{front_text:{has_glowing_text:1b,messages:['""','{"text":"明星","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger lobby_action set 1"}}','{"text":"Celebrity","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger lobby_action set 1"}}','""']}}
setblock 35 -49 -16 minecraft:cherry_wall_sign[facing=east,waterlogged=false]{front_text:{has_glowing_text:1b,messages:['""','{"text":"企业家","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger lobby_action set 2"}}','{"text":"Entrepreneur","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger lobby_action set 2"}}','""']}}
setblock 35 -49 -17 minecraft:cherry_wall_sign[facing=east,waterlogged=false]{front_text:{has_glowing_text:1b,messages:['""','{"text":"社区领袖","color":"red","clickEvent":{"action":"run_command","value":"/trigger lobby_action set 3"}}','{"text":"Community Leader","color":"red","clickEvent":{"action":"run_command","value":"/trigger lobby_action set 3"}}','""']}}
setblock 35 -49 -18 minecraft:cherry_wall_sign[facing=east,waterlogged=false]{front_text:{has_glowing_text:1b,messages:['""','{"text":"学者","color":"green","clickEvent":{"action":"run_command","value":"/trigger lobby_action set 4"}}','{"text":"Scholar","color":"green","clickEvent":{"action":"run_command","value":"/trigger lobby_action set 4"}}','""']}}
setblock 35 -49 -19 minecraft:cherry_wall_sign[facing=east,waterlogged=false]{front_text:{color:"light_gray",has_glowing_text:1b,messages:['""','{"text":"公务员","color":"#F5F5DC","clickEvent":{"action":"run_command","value":"/trigger lobby_action set 5"}}','{"text":"Civil Servant","color":"#F5F5DC","clickEvent":{"action":"run_command","value":"/trigger lobby_action set 5"}}','""']}}
setblock 35 -49 -20 minecraft:cherry_wall_sign[facing=east,waterlogged=false]{front_text:{color:"orange",has_glowing_text:1b,messages:['""','{"text":"军人","color":"#FFA500","clickEvent":{"action":"run_command","value":"/trigger lobby_action set 6"}}','{"text":"Military Officer","color":"#FFA500","clickEvent":{"action":"run_command","value":"/trigger lobby_action set 6"}}','""']}}
setblock 35 -49 -21 minecraft:cherry_wall_sign[facing=east,waterlogged=false]{front_text:{has_glowing_text:1b,messages:['""','{"text":"律师","color":"light_purple","clickEvent":{"action":"run_command","value":"/trigger lobby_action set 7"}}','{"text":"Lawyer","color":"light_purple","clickEvent":{"action":"run_command","value":"/trigger lobby_action set 7"}}','""']}}
setblock 35 -49 -22 minecraft:cherry_wall_sign[facing=east,waterlogged=false]{front_text:{has_glowing_text:1b,messages:['""','{"text":"医生","color":"#012696","clickEvent":{"action":"run_command","value":"/trigger lobby_action set 8"}}','{"text":"Doctor","color":"#012696","clickEvent":{"action":"run_command","value":"/trigger lobby_action set 8"}}','""']}}
setblock 45 -50 -13 minecraft:cherry_wall_sign[facing=north,waterlogged=false]{front_text:{has_glowing_text:1b,messages:['""','{"text":"教程","color":"gold","bold":true,"clickEvent":{"action":"run_command","value":"/trigger lobby_action set 9"}}','{"text":"Tutorial","color":"gold","bold":true,"clickEvent":{"action":"run_command","value":"/trigger lobby_action set 9"}}','""']}}
execute unless score #start_pending phase matches 1 run setblock 49 -50 -13 minecraft:cherry_wall_sign[facing=north,waterlogged=false]{front_text:{has_glowing_text:1b,messages:['""','{"text":"开始游戏","color":"white","bold":true,"clickEvent":{"action":"run_command","value":"/trigger lobby_action set 10"}}','{"text":"Start Game","color":"white","bold":true,"clickEvent":{"action":"run_command","value":"/trigger lobby_action set 10"}}','""']}}
setblock 53 -50 -13 minecraft:cherry_wall_sign[facing=north,waterlogged=false]{front_text:{has_glowing_text:1b,messages:['""','{"text":"关于","color":"aqua","bold":true,"clickEvent":{"action":"run_command","value":"/trigger lobby_action set 13"}}','{"text":"About","color":"aqua","bold":true,"clickEvent":{"action":"run_command","value":"/trigger lobby_action set 13"}}','""']}}
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:choose_time [{"text":"","font":"minecraft:default"},{"translate":"rfm.bossbar.choose.offset_left","font":"rfm:bossbar"},{"text":"\uE100","font":"rfm:bossbar","color":"white"},{"text":"\uE101","font":"rfm:bossbar"},{"translate":"rfm.bossbar.choose.offset_right","font":"rfm:bossbar"},{"translate":"rfm.text.c9ab18509d8b","color":"light_purple"}]
