...
#开始游戏
execute unless score #start_pending phase matches 1 run setblock 49 -50 -13 minecraft:cherry_wall_sign[facing=north,waterlogged=false]{front_text:{has_glowing_text:1b,messages:['""','{"text":"开始游戏","color":"white","bold":true,"clickEvent":{"action":"run_command","value":"/trigger lobby_action set 10"}}','""','""']}}
#关于
...
#创建选择倒计时条
execute unless score #start_pending phase matches 1 run bossbar add rfm:choose_time [{"text":"","font":"minecraft:default"},{"text":"\uE20E","font":"rfm:bossbar"},{"text":"\uE100","font":"rfm:bossbar","color":"white"},{"text":"\uE101","font":"rfm:bossbar"},{"text":"\uE232","font":"rfm:bossbar"},{"text":"任务选择时间","color":"light_purple"}]
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:speech_time [{"text":"街头演讲","color":"aqua"}]
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:visit_time [{"text":"社区拜访","color":"aqua"}]
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:photo_time [{"text":"市民合影","color":"aqua"}]
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:qa_time [{"text":"公开答疑","color":"aqua"}]
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:cheer_time [{"text":"市民应援","color":"aqua"}]
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:emission_time [{"text":"排放口选择时间","color":"green"}]
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:sample_time [{"text":"河道取样","color":"blue"}]
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:park_time [{"text":"公园维护","color":"green"}]
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:trash_time [{"text":"垃圾分类督导","color":"green"}]
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:energy_time [{"text":"清洁能源检查","color":"yellow"}]
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:market_time [{"text":"市场调研","color":"yellow"}]
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:negotiation_time [{"text":"招商洽谈","color":"yellow"}]
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:audit_time [{"text":"预算核查","color":"yellow"}]
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:supply_time [{"text":"商圈巡查","color":"yellow"}]
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:employment_time [{"text":"就业走访","color":"yellow"}]
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:hospital_time [{"text":"医院排队疏导","color":"red"}]
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:fitness_time [{"text":"全民健身挑战","color":"red"}]
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:exercise_time [{"text":"课间操领队","color":"red"}]
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:bus_time [{"text":"公交站调度","color":"red"}]
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:cooking_time [{"text":"厨艺大比拼","color":"red"}]
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:swim_time {"text":"奋泳争先","color":"aqua"}
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:needle_time {"text":"见缝插针","color":"light_purple"}
...
execute unless score #start_pending phase matches 1 run bossbar add rfm:lottery_time {"text":"命中注定","color":"gold"}
