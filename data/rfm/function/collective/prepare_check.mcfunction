...
execute if score #session_online game_session = #session_size game_session if score #online_total player_count = #ready_total player_count if score #online_total player_count matches 1.. run function rfm:collective/game/draw
