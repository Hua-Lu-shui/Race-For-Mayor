...
item replace entity @a[tag=rfm_potato_holder,limit=1] hotbar.4 with minecraft:oxeye_daisy[minecraft:custom_name='{"translate":"rfm.text.68c551926544","color":"yellow","bold":true,"italic":false}',minecraft:lore=['{"translate":"rfm.text.c297bd22c6db","color":"white","italic":false}'],minecraft:attribute_modifiers={modifiers:[{id:"rfm:hot_potato_reach",type:"minecraft:player.entity_interaction_range",amount:3.0,operation:"add_value",slot:"hand"}],show_in_tooltip:false},minecraft:enchantment_glint_override=true,minecraft:custom_data={rfm_hot_potato:1}] 1
