...
item replace entity @a[tag=rfm_potato_holder,limit=1] hotbar.4 with minecraft:oxeye_daisy[minecraft:custom_name='{"text":"滨菊","color":"yellow","bold":true,"italic":false}',minecraft:lore=['{"text":"右键其他玩家，将滨菊传出","color":"white","italic":false}'],minecraft:enchantment_glint_override=true,minecraft:custom_data={rfm_hot_potato:1}] 1
...
tellraw @a[tag=rfm_potato_holder] {"text":"你拿到了滨菊！3秒内右键其他玩家传出。","color":"yellow","bold":true}
