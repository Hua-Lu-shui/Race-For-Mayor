...
execute if score #selected_game group_game matches 4 run function rfm:collective/game/slot_4/start
execute if score #selected_game group_game matches 5 run function rfm:collective/game/slot_5/start
