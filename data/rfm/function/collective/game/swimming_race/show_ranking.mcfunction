tellraw @a {"text":"—— 奋泳争先最终排名 ——","color":"gold","bold":true}
execute as @a[scores={group_rank=1}] run tellraw @a [{"text":"第1名  ","color":"#FFD700"},{"selector":"@s","color":"white"}]
execute as @a[scores={group_rank=2}] run tellraw @a [{"text":"第2名  ","color":"#C0C0C0"},{"selector":"@s","color":"white"}]
execute as @a[scores={group_rank=3}] run tellraw @a [{"text":"第3名  ","color":"#CD7F32"},{"selector":"@s","color":"white"}]
