...
title @a title [{"text":"令牌争夺","color":"#C6A8FF","bold":true},{"text":"：奋泳争先","color":"aqua","bold":true}]
title @a subtitle [{"text":"抢先按下自己泳道的终点按钮","color":"white"}]
tellraw @a [{"text":"【令牌争夺】","color":"#C6A8FF","bold":true},{"text":"奋泳争先","color":"aqua","bold":true}]
tellraw @a [{"text":"【游戏规则】","color":"#67D5FF","bold":true},{"text":"每名玩家从独立起点出发。游到自己泳道末端并按下终点按钮即完成比赛，越早按下按钮的玩家排名越高。","color":"white"}]
