...
tellraw @a[tag=rfm_participant] [{"translate":"rfm.text.2d703985ac61","color":"#C6A8FF","bold":true},{"translate":"rfm.text.e6cdff9d469a","color":"aqua","bold":true}]
tellraw @a[tag=rfm_participant] [{"translate":"rfm.text.bdd9d6550396","color":"#67D5FF","bold":true},{"translate":"rfm.text.a54d64662b81","color":"white"}]
