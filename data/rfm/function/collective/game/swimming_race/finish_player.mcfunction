...
tellraw @a [{"selector":"@s","color":"aqua","bold":true},{"text":" 已按下自己泳道的终点按钮，当前到达名次：第","color":"white"},{"score":{"name":"#group_arrival","objective":"group_arrival"},"color":"gold","bold":true},{"text":"名","color":"gold","bold":true}]
