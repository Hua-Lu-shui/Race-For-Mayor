...
tellraw @a[tag=rfm_participant] [{"selector":"@s","color":"light_purple","bold":true},{"text":" 已抵达顶部终点，当前到达名次：第","color":"white"},{"score":{"name":"#group_arrival","objective":"group_arrival"},"color":"gold","bold":true},{"text":"名","color":"gold","bold":true}]
