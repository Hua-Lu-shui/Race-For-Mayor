...
tellraw @a[tag=rfm_participant] [{"selector":"@s","color":"gold","bold":true},{"text":" 抽中了第","color":"white"},{"score":{"name":"@s","objective":"group_rank"},"color":"gold","bold":true},{"text":"名！","color":"gold","bold":true}]
