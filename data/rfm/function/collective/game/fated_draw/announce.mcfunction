...
item replace entity @a[tag=rfm_participant] hotbar.4 with minecraft:map[minecraft:custom_name='{"text":"准备开始","color":"#C6A8FF","bold":true,"italic":false}',minecraft:lore=['{"text":"全员准备后开始抽签","color":"gray","italic":false}'],minecraft:custom_data={collective_start_ready:1}] 1
