advancement revoke @s only rfm:lottery_pick_6
...
execute unless entity @e[type=minecraft:interaction,tag=rfm_lottery_slot_6,limit=1] run return 0
tag @e[type=minecraft:interaction,tag=rfm_lottery_interaction] remove rfm_lottery_selected
tag @e[type=minecraft:interaction,tag=rfm_lottery_slot_6,limit=1] add rfm_lottery_selected
