...
execute if score #selected_game group_game matches 4 run function rfm:collective/game/hot_potato/lock_position
execute if score #selected_game group_game matches 5 run function rfm:collective/game/marksman/lock_position
