...
title @a title {"text":"令牌争夺：城市议题响应赛","color":"gold","bold":true}
title @a subtitle {"text":"抢先抵达正确的属性区域，争夺更高排名","color":"yellow"}
tellraw @a {"text":"【令牌争夺】城市议题响应赛","color":"gold","bold":true}
...
tellraw @a [{"text":"【排名奖励】","color":"light_purple","bold":true},{"text":"排名越高，越先进入令牌屋挑选令牌。其他候选人将在等待屋等候。","color":"white"}]
