...
execute if block 936 -60 114 minecraft:stone_button[powered=true] run scoreboard players set @s bus_answer 1
execute if block 948 -60 114 minecraft:stone_button[powered=true] run scoreboard players set @s bus_answer 2
execute if block 960 -60 114 minecraft:stone_button[powered=true] run scoreboard players set @s bus_answer 3
