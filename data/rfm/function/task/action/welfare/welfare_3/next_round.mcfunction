...
tellraw @a [{"text":"【课间操领队】","color":"red","bold":true},{"selector":"@s","color":"white"},{"text":" 完成第 ","color":"green"},{"score":{"name":"@s","objective":"exercise_round"},"color":"yellow"},{"text":" 轮动作！","color":"green"}]
