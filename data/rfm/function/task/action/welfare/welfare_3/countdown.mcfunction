...
execute if score @s exercise_delay matches 40 run title @a title {"text":"2","color":"yellow","bold":true}
execute if score @s exercise_delay matches 40 run playsound minecraft:block.note_block.hat master @a ~ ~ ~ 1 1 1
execute if score @s exercise_delay matches 20 run title @a title {"text":"1","color":"red","bold":true}
