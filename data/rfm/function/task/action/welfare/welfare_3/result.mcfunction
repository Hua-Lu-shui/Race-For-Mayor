...
execute if score @s exercise_round matches 4.. run tellraw @a [{"text":"【课间操领队】","color":"red","bold":true},{"selector":"@s","color":"white"},{"text":" 完美！","color":"gold","bold":true},{"text":" 民生 +16","color":"red"}]
...
execute if score @s exercise_round matches ..2 run tellraw @a [{"text":"【课间操领队】","color":"red","bold":true},{"selector":"@s","color":"white"},{"text":" 任务失败。","color":"red","bold":true},{"text":" 民生 +4","color":"red"}]
