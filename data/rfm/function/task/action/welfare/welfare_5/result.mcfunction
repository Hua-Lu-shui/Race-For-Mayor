...
execute if score @s cooking_clicks matches 250.. if score @s cooking_time matches 200.. run tellraw @a [{"text":"【厨艺大比拼】","color":"red","bold":true},{"selector":"@s","color":"white"},{"text":" 完美！","color":"gold","bold":true},{"text":" 民生 +16","color":"red"}]
...
execute if score @s cooking_clicks matches ..249 run tellraw @a [{"text":"【厨艺大比拼】","color":"red","bold":true},{"selector":"@s","color":"white"},{"text":" 任务失败。","color":"red","bold":true},{"text":" 民生 +4","color":"red"}]
