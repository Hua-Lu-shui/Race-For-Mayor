...
bossbar set rfm:manhole_time name [{"text":"","font":"minecraft:default"},{"text":"\uE219","font":"rfm:bossbar"},{"text":"\uE100","font":"rfm:bossbar","color":"white"},{"text":"\uE101","font":"rfm:bossbar"},{"text":"\uE227","font":"rfm:bossbar"},{"text":"井盖安全巡检  ·  已修复 ","color":"red"},{"score":{"name":"@s","objective":"manhole_repaired"},"color":"yellow"},{"text":" / 6","color":"red"}]
