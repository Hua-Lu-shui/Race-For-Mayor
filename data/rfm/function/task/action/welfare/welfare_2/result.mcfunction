...
execute unless score @s fitness_checkpoint matches 5 run tellraw @a [{"text":"【全民健身挑战】","color":"red","bold":true},{"selector":"@s","color":"white"},{"text":" 未能在规定时间内冲过终点。","color":"red","bold":true},{"text":" 属性保持不变","color":"gray"}]
