...
summon minecraft:text_display 115 -57 -66 {Tags:["rfm_hospital_label"],text:'{"translate":"rfm.text.c62a573dead7","color":"green","bold":true}',billboard:"center",alignment:"center",background:0,shadow:1b,see_through:0b}
