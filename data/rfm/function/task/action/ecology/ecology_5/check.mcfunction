...
execute if score @s energy_round matches ..5 run function rfm:task/action/ecology/ecology_5/prepare_round
execute if score @s energy_round matches 6.. run function rfm:task/action/ecology/ecology_5/result
