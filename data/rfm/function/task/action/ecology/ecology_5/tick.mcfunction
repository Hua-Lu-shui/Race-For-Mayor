...
execute if block 268 -60 102 minecraft:lever[powered=true] run scoreboard players add @s energy_total 1
execute if block 271 -60 102 minecraft:lever[powered=true] run scoreboard players add @s energy_total 2
execute if block 274 -60 102 minecraft:lever[powered=true] run scoreboard players add @s energy_total 3
execute if block 277 -60 102 minecraft:lever[powered=true] run scoreboard players add @s energy_total 4
...
#确认按钮按下时提交本轮答案
execute if block 272 -60 107 minecraft:stone_button[powered=true] run function rfm:task/action/ecology/ecology_5/check
