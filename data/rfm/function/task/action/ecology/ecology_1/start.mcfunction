...
#生成可自由走动的空中观战平台
fill 95 -55 110 105 -55 118 minecraft:light_gray_stained_glass
setblock 100 -55 114 minecraft:sea_lantern
fill 95 -54 110 105 -52 110 minecraft:glass
fill 95 -54 118 105 -52 118 minecraft:glass
fill 95 -54 111 95 -52 117 minecraft:glass
fill 105 -54 111 105 -52 117 minecraft:glass
...
tellraw @a {"text":"请行动玩家阅读教程。准备完成后，扔出快捷栏中的“准备完成”空地图。","color":"yellow"}

#只发放一张准备空地图；编号纸条将在倒计时结束后发放
item replace entity @s hotbar.4 with minecraft:map[minecraft:custom_name='{"text":"准备完成","color":"green","bold":true,"italic":false}',minecraft:lore=['{"text":"按Q扔出后开始倒计时","color":"gray","italic":false}'],minecraft:custom_data={emission_ready:1}] 1
