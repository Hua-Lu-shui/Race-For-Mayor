...
bossbar set rfm:emission_time name [{"text":"","font":"minecraft:default"},{"text":"\uE21B","font":"rfm:bossbar"},{"text":"\uE100","font":"rfm:bossbar","color":"white"},{"text":"\uE101","font":"rfm:bossbar"},{"text":"\uE225","font":"rfm:bossbar"},{"text":"第 ","color":"white"},{"score":{"name":"@s","objective":"emission_round"},"color":"gold"},{"text":" / 10 轮  ·  剩余时间：2.0 秒","color":"green"}]
