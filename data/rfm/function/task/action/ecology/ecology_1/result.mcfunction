...
execute if score @s emission_correct matches 10 run tellraw @a[tag=rfm_participant] [{"text":"【排放巡查】","color":"green","bold":true},{"selector":"@s","color":"white"},{"text":" 完美！","color":"gold","bold":true},{"text":" 生态 +16","color":"green"}]
...
execute if score @s emission_correct matches 6..9 run tellraw @a[tag=rfm_participant] [{"text":"【排放巡查】","color":"green","bold":true},{"selector":"@s","color":"white"},{"text":" 任务完成！","color":"green","bold":true},{"text":" 生态 +10","color":"green"}]
...
execute if score @s emission_correct matches ..5 run tellraw @a[tag=rfm_participant] [{"text":"【排放巡查】","color":"green","bold":true},{"selector":"@s","color":"white"},{"text":" 任务失败。","color":"red","bold":true},{"text":" 生态 +4","color":"green"}]

tellraw @a[tag=rfm_participant] [{"text":"排放巡查结束，","color":"white"},{"selector":"@s","color":"white"},{"text":" 共判断正确 ","color":"white"},{"score":{"name":"@s","objective":"emission_correct"},"color":"green"},{"text":" / 10 次。","color":"white"}]
