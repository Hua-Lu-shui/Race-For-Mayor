...
execute if score @s emission_correct matches 6..9 run tellraw @a [{"text":"【排放巡查】","color":"green","bold":true},{"selector":"@s","color":"white"},{"text":" 任务完成！","color":"green","bold":true},{"text":" 生态 +10","color":"green"}]
...
execute if score @s emission_correct matches ..5 run tellraw @a [{"text":"【排放巡查】","color":"green","bold":true},{"selector":"@s","color":"white"},{"text":" 任务失败。","color":"red","bold":true},{"text":" 生态 +4","color":"green"}]
