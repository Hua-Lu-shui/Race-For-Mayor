...
execute if score @s trash_correct matches 10 run tellraw @a [{"text":"【垃圾分类督导】","color":"green","bold":true},{"selector":"@s","color":"white"},{"text":" 完美！","color":"gold","bold":true},{"text":" 生态 +16","color":"green"}]

execute if score @s trash_correct matches 7..9 run scoreboard players add @s ecology 10
execute if score @s trash_correct matches 7..9 run tellraw @a [{"text":"【垃圾分类督导】","color":"green","bold":true},{"selector":"@s","color":"white"},{"text":" 任务完成！","color":"green","bold":true},{"text":" 生态 +10","color":"green"}]

execute if score @s trash_correct matches ..6 run scoreboard players add @s ecology 4
execute if score @s trash_correct matches ..6 run tellraw @a [{"text":"【垃圾分类督导】","color":"green","bold":true},{"selector":"@s","color":"white"},{"text":" 任务失败。","color":"red","bold":true},{"text":" 生态 +4","color":"green"}]
