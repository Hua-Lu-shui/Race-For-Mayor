...
bossbar set rfm:park_time name [{"text":"","font":"minecraft:default"},{"text":"\uE216","font":"rfm:bossbar"},{"text":"\uE100","font":"rfm:bossbar","color":"white"},{"text":"\uE101","font":"rfm:bossbar"},{"text":"\uE22A","font":"rfm:bossbar"},{"text":"公园维护  ·  已完成 ","color":"green"},{"score":{"name":"@s","objective":"park_progress"},"color":"yellow"},{"text":" / 6","color":"green"}]
particle minecraft:happy_villager ~ ~1 ~ 0.45 0.45 0.45 0.02 12 force @a
