...
execute if score @s park_progress matches ..5 run item replace entity @s hotbar.4 with minecraft:paper[minecraft:custom_name='{"translate":"rfm.text.aa8fb53f4022","color":"green","bold":true,"italic":false}',minecraft:lore=['{"translate":"rfm.text.949db26ca5d3","color":"gray","italic":false}'],minecraft:custom_data={park_check:1}] 1
