...
execute if score @s park_progress matches 5 positioned 205 -58 70 if entity @e[type=minecraft:item,distance=..2,limit=1,nbt={Item:{components:{"minecraft:custom_data":{park_check:1}}}}] run function rfm:task/action/ecology/ecology_3/check
