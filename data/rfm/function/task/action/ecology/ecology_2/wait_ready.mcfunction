...
execute if entity @e[type=minecraft:item,distance=..3,limit=1,nbt={Item:{components:{"minecraft:custom_data":{sample_ready:1}}}}] run tellraw @a[tag=rfm_participant] {"translate":"rfm.text.299865b28b90","color":"green","bold":true}
