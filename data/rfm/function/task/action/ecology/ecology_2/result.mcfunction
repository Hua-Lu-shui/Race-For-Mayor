...
#4至5个取样点：完成，生态+12
execute if score @s sample_progress matches 4..5 run scoreboard players add @s ecology 12
execute if score @s sample_progress matches 4..5 run tellraw @a [{"text":"【河道取样】","color":"green","bold":true},{"selector":"@s","color":"white"},{"text":" 任务完成！","color":"green","bold":true},{"text":" 生态 +12","color":"green"}]
