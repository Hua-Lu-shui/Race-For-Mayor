...
execute if score @s sample_progress matches 6 run tellraw @a [{"text":"【河道取样】","color":"aqua","bold":true},{"selector":"@s","color":"gold"},{"text":" 完美完成任务！","color":"gold","bold":true},{"text":" 生态 +8","color":"green"}]

#4至5个取样点：通过，生态+6
execute if score @s sample_progress matches 4..5 run scoreboard players add @s ecology 6
execute if score @s sample_progress matches 4..5 run tellraw @a [{"text":"【河道取样】","color":"aqua","bold":true},{"selector":"@s","color":"gold"},{"text":" 通过任务！","color":"green","bold":true},{"text":" 生态 +6","color":"green"}]
