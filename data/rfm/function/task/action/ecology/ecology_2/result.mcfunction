...
execute if score @s sample_progress matches 6 if score @s sample_time matches 200.. run tellraw @a [{"text":"【河道取样】","color":"green","bold":true},{"selector":"@s","color":"white"},{"text":" 完美！","color":"gold","bold":true},{"text":" 生态 +16","color":"green"}]
...
execute if score @s sample_progress matches 6 if score @s sample_time matches ..199 run tellraw @a [{"text":"【河道取样】","color":"green","bold":true},{"selector":"@s","color":"white"},{"text":" 任务完成！","color":"green","bold":true},{"text":" 生态 +10","color":"green"}]

#40秒倒计时结束时仍未完成全部6个取样点：失败，生态+4
execute if score @s sample_progress matches ..5 run scoreboard players add @s ecology 4
execute if score @s sample_progress matches ..5 run tellraw @a [{"text":"【河道取样】","color":"green","bold":true},{"selector":"@s","color":"white"},{"text":" 任务失败。","color":"red","bold":true},{"text":" 生态 +4","color":"green"}]
