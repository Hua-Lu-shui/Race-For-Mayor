...
bossbar set rfm:sample_time players @a
bossbar set rfm:sample_time max 800
bossbar set rfm:sample_time value 800
bossbar set rfm:sample_time name [{"text":"\uE216","font":"rfm:bossbar"},{"text":"\uE100","font":"rfm:bossbar","color":"white"},{"text":"\uE101","font":"rfm:bossbar"},{"text":"\uE22A","font":"rfm:bossbar"},{"text":"河道取样  ·  已完成 ","color":"aqua"},{"score":{"name":"@s","objective":"sample_progress"},"color":"gold"},{"text":" / 6","color":"aqua"}]
