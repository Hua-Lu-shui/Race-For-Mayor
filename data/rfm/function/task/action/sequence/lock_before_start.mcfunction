...
execute if score @s action_task matches 604 if score @s qa_state matches 2..3 run tp @s 204 -58 -21
execute if score @s action_task matches 605 if score @s cheer_state matches 2..3 run tp @s 232 -59 -18
...
execute if score @s action_task matches 805 if score @s cooking_state matches 2..3 run tp @s 263 -58 -67
