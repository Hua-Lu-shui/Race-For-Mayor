...
execute if score @s supply_completed matches 3..4 run tellraw @a [{"text":"【商圈巡查】","color":"yellow","bold":true},{"selector":"@s","color":"white"},{"text":" 任务完成！","color":"green","bold":true},{"text":" 经济 +10","color":"yellow"}]

execute if score @s supply_completed matches ..2 run scoreboard players add @s economy 4
execute if score @s supply_completed matches ..2 run tellraw @a [{"text":"【商圈巡查】","color":"yellow","bold":true},{"selector":"@s","color":"white"},{"text":" 任务失败。","color":"red","bold":true},{"text":" 经济 +4","color":"yellow"}]
