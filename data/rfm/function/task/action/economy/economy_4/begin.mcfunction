...
tellraw @a[tag=rfm_participant] [{"text":"临时仓库已经开放，请逐箱寻找","color":"white"},{"text":"所需物资","color":"#67D5FF","bold":true},{"text":"并完成","color":"white"},{"text":"五家店铺的补货","color":"#FFD166","bold":true},{"text":"！","color":"white"}]
