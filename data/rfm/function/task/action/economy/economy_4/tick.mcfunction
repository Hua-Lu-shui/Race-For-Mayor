...
bossbar set rfm:supply_time name [{"text":"\uE217","font":"rfm:bossbar"},{"text":"\uE100","font":"rfm:bossbar","color":"white"},{"text":"\uE101","font":"rfm:bossbar"},{"text":"\uE229","font":"rfm:bossbar"},{"text":"商圈巡查 · 补货进度 ","color":"yellow"},{"score":{"name":"@s","objective":"supply_completed"},"color":"green","bold":true},{"text":" / 5","color":"yellow"}]
