...
bossbar set rfm:supply_time name [{"translate":"rfm.text.207c947d2419","color":"yellow"},{"score":{"name":"@s","objective":"supply_completed"},"color":"green","bold":true},{"text":" / 5","color":"yellow"}]
