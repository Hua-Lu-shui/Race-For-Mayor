...
bossbar set rfm:audit_time name [{"text":"\uE214","font":"rfm:bossbar"},{"text":"\uE100","font":"rfm:bossbar","color":"white"},{"text":"\uE101","font":"rfm:bossbar"},{"text":"\uE22C","font":"rfm:bossbar"},{"text":"预算核查 · 找出虚假账本","color":"yellow"}]
