...
execute if score @s audit_correct matches 1 if score @s audit_time matches 1200.. run tellraw @a[tag=rfm_participant] [{"text":"【预算核查】","color":"yellow","bold":true},{"selector":"@s","color":"white"},{"text":" 完美！","color":"gold","bold":true},{"text":" 经济 +16","color":"yellow"}]

execute if score @s audit_correct matches 1 if score @s audit_time matches 1..1199 run scoreboard players add @s economy 10
execute if score @s audit_correct matches 1 if score @s audit_time matches 1..1199 run tellraw @a[tag=rfm_participant] [{"text":"【预算核查】","color":"yellow","bold":true},{"selector":"@s","color":"white"},{"text":" 任务完成！","color":"green","bold":true},{"text":" 经济 +10","color":"yellow"}]
