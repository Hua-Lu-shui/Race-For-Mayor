...
tellraw @a [{"text":"右键拾取","color":"white"},{"text":"三本账本","color":"#67D5FF","bold":true},{"text":"并逐页核算；预算上限、可退押金、已结清款项等不计入本次申报。确认后选中","color":"white"},{"text":"虚假账本","color":"#FFD166","bold":true},{"text":"，将其交给财政负责人。","color":"white"}]
