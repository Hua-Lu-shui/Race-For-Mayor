...
execute if score @s market_correct matches 1 if score @s market_time matches 0..399 run tellraw @a [{"text":"【市场调研】","color":"yellow","bold":true},{"selector":"@s","color":"white"},{"text":" 任务完成！","color":"green","bold":true},{"text":" 经济 +10","color":"yellow"}]

#选错或40秒内没有完成交易：失败
execute if score @s market_correct matches 0 run scoreboard players add @s economy 4
execute if score @s market_correct matches 0 run tellraw @a [{"text":"【市场调研】","color":"yellow","bold":true},{"selector":"@s","color":"white"},{"text":" 任务失败。","color":"red","bold":true},{"text":" 经济 +4","color":"yellow"}]
