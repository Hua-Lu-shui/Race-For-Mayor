...
execute if score @s negotiation_delay matches 40 run title @a title {"text":"2","color":"yellow","bold":true}
execute if score @s negotiation_delay matches 40 run playsound minecraft:block.note_block.hat master @a ~ ~ ~ 1 1 1
