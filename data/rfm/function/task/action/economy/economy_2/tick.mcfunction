...
bossbar set rfm:negotiation_time name [{"text":"","font":"minecraft:default"},{"text":"\uE21C","font":"rfm:bossbar"},{"text":"\uE100","font":"rfm:bossbar","color":"white"},{"text":"\uE101","font":"rfm:bossbar"},{"text":"\uE224","font":"rfm:bossbar"},{"text":"招商洽谈 · 已完成 ","color":"yellow"},{"score":{"name":"@s","objective":"negotiation_round"},"color":"gold"},{"text":" / 9 · 正确 ","color":"yellow"},{"score":{"name":"@s","objective":"negotiation_correct"},"color":"green"}]
