...
execute if score @s action_task matches 0 run tellraw @a[tag=rfm_participant] [{"text":"本回合行动玩家 ","color":"gray"},{"selector":"@s","color":"white"},{"text":" 没有在倒计时内选择行动方向。","color":"gray"}]
