...
execute if score @s action_task matches 603 if score @s photo_state matches 1 run tellraw @a[tag=rfm_participant] {"translate":"rfm.text.f825c708fc24","color":"blue"}
