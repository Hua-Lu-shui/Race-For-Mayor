...
bossbar set rfm:photo_time name [{"text":"","font":"minecraft:default"},{"text":"\uE21D","font":"rfm:bossbar"},{"text":"\uE100","font":"rfm:bossbar","color":"white"},{"text":"\uE101","font":"rfm:bossbar"},{"text":"\uE223","font":"rfm:bossbar"},{"text":"市民合影 · 剩余 ","color":"aqua"},{"score":{"name":"@s","objective":"photo_seconds"},"color":"white"},{"text":" 秒 · 已提交 ","color":"aqua"},{"score":{"name":"@s","objective":"photo_attempt"},"color":"yellow"},{"text":" / 2","color":"aqua"}]
