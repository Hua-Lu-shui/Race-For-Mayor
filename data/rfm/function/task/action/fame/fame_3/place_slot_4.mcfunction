scoreboard players operation @s photo_previous = @s photo_slot_4
...
scoreboard players operation @s photo_slot_4 = @s photo_selected
tp @e[tag=rfm_photo_selected] 178 -58.9 -25 0 0
tag @e[tag=rfm_photo_selected] remove rfm_photo_selected
scoreboard players set @s photo_selected 0
tellraw @a[tag=rfm_participant] {"translate":"rfm.text.555ee68ebad5","color":"green"}
