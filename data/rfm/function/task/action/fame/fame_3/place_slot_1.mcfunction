scoreboard players operation @s photo_previous = @s photo_slot_1
...
scoreboard players operation @s photo_slot_1 = @s photo_selected
tp @e[tag=rfm_photo_selected] 176 -58.9 -29 0 0
tag @e[tag=rfm_photo_selected] remove rfm_photo_selected
scoreboard players set @s photo_selected 0
tellraw @a[tag=rfm_participant] {"translate":"rfm.text.2704ae7652cd","color":"green"}
