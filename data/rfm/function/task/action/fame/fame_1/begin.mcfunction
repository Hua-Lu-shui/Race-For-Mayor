...
bossbar set rfm:speech_time name [{"text":"\uE216","font":"rfm:bossbar"},{"text":"\uE100","font":"rfm:bossbar","color":"white"},{"text":"\uE101","font":"rfm:bossbar"},{"text":"\uE22A","font":"rfm:bossbar"},{"text":"街头演讲 · 观察市民反应！","color":"aqua"}]
