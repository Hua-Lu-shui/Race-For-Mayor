...
bossbar set rfm:speech_time name [{"text":"","font":"minecraft:default"},{"text":"\uE21C","font":"rfm:bossbar"},{"text":"\uE100","font":"rfm:bossbar","color":"white"},{"text":"\uE101","font":"rfm:bossbar"},{"text":"\uE224","font":"rfm:bossbar"},{"text":"街头演讲 · 已完成 ","color":"aqua"},{"score":{"name":"@s","objective":"speech_round"},"color":"white"},{"text":" / 10 · 成功 ","color":"aqua"},{"score":{"name":"@s","objective":"speech_correct"},"color":"green"}]
