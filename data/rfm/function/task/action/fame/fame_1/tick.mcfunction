...
execute if block 485 -60 107 minecraft:stone_button[powered=true] run scoreboard players set @s speech_answer 1
execute if block 488 -60 107 minecraft:stone_button[powered=true] run scoreboard players set @s speech_answer 2
execute if block 491 -60 107 minecraft:stone_button[powered=true] run scoreboard players set @s speech_answer 3
