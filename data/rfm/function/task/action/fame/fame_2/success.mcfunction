...
playsound minecraft:entity.villager.celebrate master @a ~ ~ ~ 1 1.1 1
tellraw @a [{"selector":"@s","color":"white"},{"text":" 成功拜访了 ","color":"green"},{"score":{"name":"@s","objective":"visit_answer"},"color":"aqua","bold":true},{"text":" 户。","color":"green"}]
