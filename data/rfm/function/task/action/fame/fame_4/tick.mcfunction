...
bossbar set rfm:qa_time name [{"text":"","font":"minecraft:default"},{"text":"\uE225","font":"rfm:bossbar"},{"text":"\uE100","font":"rfm:bossbar","color":"white"},{"text":"\uE101","font":"rfm:bossbar"},{"text":"\uE21B","font":"rfm:bossbar"},{"text":"公开答疑 · 第 ","color":"aqua"},{"score":{"name":"@s","objective":"qa_round"},"color":"white"},{"text":" / 8 轮 · 成功 ","color":"aqua"},{"score":{"name":"@s","objective":"qa_correct"},"color":"green"},{"text":" 次 · 反应时间3秒","color":"yellow"}]
