#显示剩余时间与当前得分
bossbar set rfm:cheer_time name [{"text":"市民应援 · 得分 ","color":"aqua"},{"score":{"name":"@s","objective":"cheer_score"},"color":"green"},{"text":" · 连击 ","color":"aqua"},{"score":{"name":"@s","objective":"cheer_combo"},"color":"yellow"}]
