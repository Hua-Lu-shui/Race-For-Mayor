...
tp @a 232 -48 -6 180 32
tp @s 232 -59 -18 180 0

tellraw @a [{"text":"【名誉行动】市民应援","color":"aqua","bold":true},{"text":" 行动玩家：","color":"white"},{"selector":"@s","color":"white"}]
tellraw @a [{"text":"追赶并拾取","color":"white"},{"text":"带绿色粒子的鲜花","color":"#67D5FF","bold":true},{"text":"，同时躲开","color":"white"},{"text":"带黄色粒子的鸡蛋","color":"#FFD166","bold":true},{"text":"。鲜花落地后很快消失，被鸡蛋击中会扣1分并清空连击。","color":"white"}]
tellraw @a [{"text":"连续接到","color":"white"},{"text":"3朵鲜花","color":"#FFCB77","bold":true},{"text":"额外得1分，连续接到","color":"white"},{"text":"5朵","color":"#FFCB77"},{"text":"再额外得2分。","color":"white"}]
