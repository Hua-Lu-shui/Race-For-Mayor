...
execute unless score @s attribute_missing matches 1 run tellraw @s [{"text":"[名誉]","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger attribute_choice set 1"}},{"text":"  提升公众形象、媒体评价、竞选声望","color":"gray"}]
