...
execute if score @s decision_task matches 219 run tellraw @s [{"text":"你选择了成立公营公司整体接管：","color":"red"},{"text":"经济 +8","color":"yellow"},{"text":"，","color":"gray"},{"text":"名誉 +4","color":"aqua"},{"text":"，","color":"gray"},{"text":"民生 -6","color":"red"}]
