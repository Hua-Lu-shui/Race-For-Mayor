...
execute if score @s decision_task matches 219 run tellraw @s [{"text":"你选择了补助师徒结对和店面改造：","color":"aqua"},{"text":"经济 +4","color":"yellow"},{"text":"，","color":"gray"},{"text":"名誉 +4","color":"aqua"},{"text":"，","color":"gray"},{"text":"民生 -2","color":"red"}]
