...
execute if score @s decision_task matches 211 run tellraw @s [{"text":"你选择了立即启动建设：","color":"red"},{"text":"经济 -4","color":"yellow"},{"text":"，","color":"gray"},{"text":"名誉 +10","color":"aqua"},{"text":"，","color":"gray"},{"text":"民生 -6","color":"red"}]
