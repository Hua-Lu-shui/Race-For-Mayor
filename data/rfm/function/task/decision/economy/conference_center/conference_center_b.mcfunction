...
execute if score @s decision_task matches 211 run tellraw @s [{"translate":"rfm.text.572babf82f86","color":"aqua"},{"translate":"rfm.text.72d780b63e29","color":"yellow"},{"text":"，","color":"gray"},{"translate":"rfm.text.546e37949bb5","color":"aqua"},{"text":"，","color":"gray"},{"translate":"rfm.text.058e6e20214e","color":"red"}]
