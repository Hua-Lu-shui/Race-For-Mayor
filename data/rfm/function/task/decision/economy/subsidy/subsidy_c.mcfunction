...
execute if score @s decision_task matches 203 run tellraw @s [{"text":"你选择了控制补贴支出：","color":"green"},{"text":"名誉 -2","color":"aqua"},{"text":"，","color":"gray"},{"text":"经济 +6","color":"yellow"},{"text":"，","color":"gray"},{"text":"民生 -2","color":"red"}]
