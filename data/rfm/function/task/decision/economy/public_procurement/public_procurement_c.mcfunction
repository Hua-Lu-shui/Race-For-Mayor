...
execute if score @s decision_task matches 215 run scoreboard players remove @s welfare 2
execute if score @s decision_task matches 215 run scoreboard players remove @s fame 1
execute if score @s decision_task matches 215 run tellraw @s {"text":"你选择了完全最低价中标：经济 +3，民生 -2，名誉 -1","color":"yellow"}
