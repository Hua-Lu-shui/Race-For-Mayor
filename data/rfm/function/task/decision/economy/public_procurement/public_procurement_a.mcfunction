...
execute if score @s decision_task matches 215 run tellraw @s [{"text":"你选择了优先本地企业：","color":"red"},{"text":"经济 +6","color":"yellow"},{"text":"，","color":"gray"},{"text":"民生 +4","color":"red"},{"text":"，","color":"gray"},{"text":"名誉 -2","color":"aqua"}]
