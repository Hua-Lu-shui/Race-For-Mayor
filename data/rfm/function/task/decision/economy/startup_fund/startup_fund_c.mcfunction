...
execute if score @s decision_task matches 207 run tellraw @s [{"text":"你选择了改为贷款担保：","color":"green"},{"text":"经济 +2","color":"yellow"},{"text":"，","color":"gray"},{"text":"民生 +2","color":"red"},{"text":"，","color":"gray"},{"text":"名誉 -2","color":"aqua"}]
