...
execute if score @s decision_task matches 216 run tellraw @s [{"text":"你选择了划出园区快速落地：","color":"red"},{"text":"经济 +10","color":"yellow"},{"text":"，","color":"gray"},{"text":"名誉 +2","color":"aqua"},{"text":"，","color":"gray"},{"text":"生态 -6","color":"green"}]
