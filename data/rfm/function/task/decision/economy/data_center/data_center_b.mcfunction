...
execute if score @s decision_task matches 216 run tellraw @s [{"text":"你选择了先建小型节能示范机房：","color":"aqua"},{"text":"经济 +4","color":"yellow"},{"text":"，","color":"gray"},{"text":"名誉 +2","color":"aqua"},{"text":"，","color":"gray"},{"text":"生态 -2","color":"green"}]
