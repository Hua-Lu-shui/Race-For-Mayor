...
execute if score @s decision_task matches 213 run tellraw @s [{"text":"你选择了先开放部分线路：","color":"aqua"},{"text":"经济 +8","color":"yellow"},{"text":"，","color":"gray"},{"text":"名誉 +2","color":"aqua"},{"text":"，","color":"gray"},{"text":"生态 -2","color":"green"}]
