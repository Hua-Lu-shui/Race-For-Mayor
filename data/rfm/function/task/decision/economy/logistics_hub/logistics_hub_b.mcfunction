...
execute if score @s decision_task matches 206 run tellraw @s [{"text":"你选择了附带交通降噪条件：","color":"aqua"},{"text":"经济 +4","color":"yellow"},{"text":"，","color":"gray"},{"text":"民生 +2","color":"red"},{"text":"，","color":"gray"},{"text":"生态 -2","color":"green"}]
