...
execute if score @s decision_task matches 209 run tellraw @s [{"text":"你选择了只补贴节能设备：","color":"aqua"},{"text":"经济 +4","color":"yellow"},{"text":"，","color":"gray"},{"text":"生态 +4","color":"green"},{"text":"，","color":"gray"},{"text":"民生 -2","color":"red"}]
