...
execute if score @s decision_task matches 316 run tellraw @s [{"text":"你选择了在交通枢纽设置共享驿站：","color":"aqua"},{"text":"民生 +8","color":"red"},{"text":"，","color":"gray"},{"text":"名誉 +2","color":"aqua"},{"text":"，","color":"gray"},{"text":"经济 -2","color":"yellow"}]
