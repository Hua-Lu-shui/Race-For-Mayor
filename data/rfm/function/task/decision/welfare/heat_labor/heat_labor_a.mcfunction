...
execute if score @s decision_task matches 317 run tellraw @s [{"translate":"rfm.text.c320f2a4e60e","color":"red"},{"translate":"rfm.text.7679d74c1c81","color":"red"},{"text":"，","color":"gray"},{"translate":"rfm.text.ddb7b732be21","color":"aqua"},{"text":"，","color":"gray"},{"translate":"rfm.text.e187c8894717","color":"yellow"}]
