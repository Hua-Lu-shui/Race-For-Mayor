...
execute if score @s decision_task matches 315 run tellraw @s [{"text":"你选择了延长所有馆开放：","color":"red"},{"text":"民生 +6","color":"red"},{"text":"，","color":"gray"},{"text":"名誉 +4","color":"aqua"},{"text":"，","color":"gray"},{"text":"经济 -4","color":"yellow"}]
