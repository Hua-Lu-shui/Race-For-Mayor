...
execute if score @s decision_task matches 306 run tellraw @s [{"text":"你选择了新建多处诊所：","color":"red"},{"text":"民生 +8","color":"red"},{"text":"，","color":"gray"},{"text":"名誉 +2","color":"aqua"},{"text":"，","color":"gray"},{"text":"经济 -6","color":"yellow"}]
