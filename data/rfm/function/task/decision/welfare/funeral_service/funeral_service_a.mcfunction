...
execute if score @s decision_task matches 320 run tellraw @s [{"text":"你选择了建立公营一站式殡葬服务：","color":"red"},{"text":"民生 +10","color":"red"},{"text":"，","color":"gray"},{"text":"名誉 +4","color":"aqua"},{"text":"，","color":"gray"},{"text":"经济 -6","color":"yellow"}]
