...
execute if score @s decision_task matches 312 run tellraw @s [{"text":"你选择了设立租房仲裁中心：","color":"red"},{"text":"民生 +8","color":"red"},{"text":"，","color":"gray"},{"text":"名誉 +2","color":"aqua"},{"text":"，","color":"gray"},{"text":"经济 -6","color":"yellow"}]
