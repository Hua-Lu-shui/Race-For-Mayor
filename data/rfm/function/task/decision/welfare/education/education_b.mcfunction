...
execute if score @s decision_task matches 303 run tellraw @s [{"text":"你选择了扩建重点校区：","color":"aqua"},{"text":"民生 +6","color":"red"},{"text":"，","color":"gray"},{"text":"名誉 +2","color":"aqua"},{"text":"，","color":"gray"},{"text":"经济 -2","color":"yellow"}]
