...
execute if score @s decision_task matches 308 run tellraw @s [{"text":"你选择了全区严格整治：","color":"red"},{"text":"民生 +10","color":"red"},{"text":"，","color":"gray"},{"text":"名誉 +2","color":"aqua"},{"text":"，","color":"gray"},{"text":"经济 -4","color":"yellow"}]
