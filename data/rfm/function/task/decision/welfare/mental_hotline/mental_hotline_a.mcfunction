...
execute if score @s decision_task matches 318 run tellraw @s [{"text":"你选择了建立全天专业危机热线：","color":"red"},{"text":"民生 +10","color":"red"},{"text":"，","color":"gray"},{"text":"名誉 +2","color":"aqua"},{"text":"，","color":"gray"},{"text":"经济 -6","color":"yellow"}]
