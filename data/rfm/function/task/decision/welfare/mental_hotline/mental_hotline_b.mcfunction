...
execute if score @s decision_task matches 318 run tellraw @s [{"translate":"rfm.text.d5957c0581f3","color":"aqua"},{"translate":"rfm.text.84b26502d2e1","color":"red"},{"text":"，","color":"gray"},{"translate":"rfm.text.d51d2d52456e","color":"aqua"},{"text":"，","color":"gray"},{"translate":"rfm.text.78f8777cc0a3","color":"yellow"}]
