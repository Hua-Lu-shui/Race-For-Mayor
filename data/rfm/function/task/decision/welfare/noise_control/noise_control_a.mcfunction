...
execute if score @s decision_task matches 311 run scoreboard players remove @s economy 3
execute if score @s decision_task matches 311 run tellraw @s {"text":"你选择了严格限制夜间营业：民生 +4，名誉 +2，经济 -3","color":"yellow"}
