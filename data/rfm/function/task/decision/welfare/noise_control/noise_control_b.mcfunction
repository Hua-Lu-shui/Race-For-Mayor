...
execute if score @s decision_task matches 311 run tellraw @s [{"text":"你选择了限定噪音和营业时段：","color":"aqua"},{"text":"民生 +4","color":"red"},{"text":"，","color":"gray"},{"text":"经济 +2","color":"yellow"},{"text":"，","color":"gray"},{"text":"名誉 +2","color":"aqua"}]
