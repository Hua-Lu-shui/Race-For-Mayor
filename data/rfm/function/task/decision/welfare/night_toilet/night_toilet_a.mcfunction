...
execute if score @s decision_task matches 319 run tellraw @s [{"text":"你选择了全城公共厕所通宵开放：","color":"red"},{"text":"民生 +8","color":"red"},{"text":"，","color":"gray"},{"text":"名誉 +4","color":"aqua"},{"text":"，","color":"gray"},{"text":"经济 -6","color":"yellow"}]
