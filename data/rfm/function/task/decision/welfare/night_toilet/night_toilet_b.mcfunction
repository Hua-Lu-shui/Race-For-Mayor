...
execute if score @s decision_task matches 319 run tellraw @s [{"text":"你选择了交通枢纽和商圈的公共厕所延时开放：","color":"aqua"},{"text":"民生 +4","color":"red"},{"text":"，","color":"gray"},{"text":"名誉 +2","color":"aqua"},{"text":"，","color":"gray"},{"text":"经济 -2","color":"yellow"}]
