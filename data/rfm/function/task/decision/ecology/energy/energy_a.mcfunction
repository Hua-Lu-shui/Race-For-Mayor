...
execute if score @s decision_task matches 405 run tellraw @s [{"text":"你选择了全面更换清洁能源设备：","color":"red"},{"text":"生态 +8","color":"green"},{"text":"，","color":"gray"},{"text":"名誉 +2","color":"aqua"},{"text":"，","color":"gray"},{"text":"经济 -6","color":"yellow"}]
