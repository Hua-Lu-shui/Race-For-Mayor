...
execute if score @s decision_task matches 405 run tellraw @s [{"text":"你选择了先改造学校和医院：","color":"aqua"},{"text":"生态 +4","color":"green"},{"text":"，","color":"gray"},{"text":"民生 +2","color":"red"},{"text":"，","color":"gray"},{"text":"经济 -2","color":"yellow"}]
