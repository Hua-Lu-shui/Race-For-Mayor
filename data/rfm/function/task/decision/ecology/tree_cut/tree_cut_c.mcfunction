...
execute if score @s decision_task matches 410 run tellraw @s [{"text":"你选择了快速砍伐重铺道路：","color":"green"},{"text":"经济 +4","color":"yellow"},{"text":"，","color":"gray"},{"text":"生态 -6","color":"green"},{"text":"，","color":"gray"},{"text":"民生 -2","color":"red"}]
