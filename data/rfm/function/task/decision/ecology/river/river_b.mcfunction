#执行生态决策任务的B方案并结算属性
execute if score @s decision_task matches 402 run scoreboard players add @s ecology 3
...
execute if score @s decision_task matches 402 run tellraw @s {"text":"你选择了先治理重点河段：生态 +3，民生 +1，经济 -1","color":"yellow"}
