...
execute if score @s decision_task matches 417 run tellraw @s [{"text":"你选择了优先治理繁殖最密集水域：","color":"aqua"},{"text":"生态 +4","color":"green"},{"text":"，","color":"gray"},{"text":"名誉 +2","color":"aqua"},{"text":"，","color":"gray"},{"text":"经济 -2","color":"yellow"}]
