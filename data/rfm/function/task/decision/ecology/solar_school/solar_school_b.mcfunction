...
execute if score @s decision_task matches 412 run tellraw @s [{"text":"你选择了先选十所学校试点：","color":"aqua"},{"text":"生态 +2","color":"green"},{"text":"，","color":"gray"},{"text":"民生 +2","color":"red"},{"text":"，","color":"gray"},{"text":"经济 -2","color":"yellow"}]
