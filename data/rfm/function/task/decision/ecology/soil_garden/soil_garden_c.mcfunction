...
execute if score @s decision_task matches 418 run tellraw @s [{"text":"你选择了关闭菜园并迁走居民活动：","color":"green"},{"text":"生态 -2","color":"green"},{"text":"，","color":"gray"},{"text":"经济 +4","color":"yellow"},{"text":"，","color":"gray"},{"text":"民生 +4","color":"red"}]
