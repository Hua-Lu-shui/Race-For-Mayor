...
execute if score @s decision_task matches 407 run scoreboard players remove @s economy 3
execute if score @s decision_task matches 407 run tellraw @s {"text":"你选择了大规模改造车道：生态 +4，民生 +2，经济 -3","color":"yellow"}
