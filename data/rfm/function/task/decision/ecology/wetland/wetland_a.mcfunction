...
execute if score @s decision_task matches 408 run tellraw @s [{"text":"你选择了划为永久保护区：","color":"red"},{"text":"生态 +10","color":"green"},{"text":"，","color":"gray"},{"text":"名誉 +2","color":"aqua"},{"text":"，","color":"gray"},{"text":"经济 -6","color":"yellow"}]
