...
execute if score @s decision_task matches 408 run tellraw @s [{"translate":"rfm.text.b3ddadb672c1","color":"red"},{"translate":"rfm.text.4bf2c9891f42","color":"green"},{"text":"，","color":"gray"},{"translate":"rfm.text.d51d2d52456e","color":"aqua"},{"text":"，","color":"gray"},{"translate":"rfm.text.e187c8894717","color":"yellow"}]
