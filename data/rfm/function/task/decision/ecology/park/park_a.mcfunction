...
execute if score @s decision_task matches 403 run tellraw @s [{"text":"你选择了全部改造成城市公园：","color":"red"},{"text":"生态 +6","color":"green"},{"text":"，","color":"gray"},{"text":"民生 +4","color":"red"},{"text":"，","color":"gray"},{"text":"经济 -6","color":"yellow"}]
