...
execute if score @s decision_task matches 419 run tellraw @s [{"text":"你选择了建设生态廊道并封闭垃圾源：","color":"red"},{"text":"生态 +8","color":"green"},{"text":"，","color":"gray"},{"text":"民生 +4","color":"red"},{"text":"，","color":"gray"},{"text":"经济 -6","color":"yellow"}]
