...
execute if score @s decision_task matches 106 run tellraw @s [{"text":"你选择了暂缓官方介入：","color":"green"},{"text":"经济 +2","color":"yellow"},{"text":"，","color":"gray"},{"text":"名誉 -4","color":"aqua"},{"text":"，","color":"gray"},{"text":"民生 -2","color":"red"}]
