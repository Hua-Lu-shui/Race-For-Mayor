...
execute if score @s decision_task matches 115 run tellraw @s [{"text":"你选择了办大型城市记忆节：","color":"red"},{"text":"名誉 +6","color":"aqua"},{"text":"，","color":"gray"},{"text":"民生 +4","color":"red"},{"text":"，","color":"gray"},{"text":"经济 -4","color":"yellow"}]
