...
execute if score @s decision_task matches 115 run tellraw @s [{"text":"你选择了只支持民间自办：","color":"green"},{"text":"经济 +2","color":"yellow"},{"text":"，","color":"gray"},{"text":"名誉 +2","color":"aqua"},{"text":"，","color":"gray"},{"text":"民生 -2","color":"red"}]
