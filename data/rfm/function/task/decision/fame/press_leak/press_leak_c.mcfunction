...
execute if score @s decision_task matches 112 run tellraw @s [{"text":"你选择了追查泄露源头优先：","color":"green"},{"text":"经济 +2","color":"yellow"},{"text":"，","color":"gray"},{"text":"名誉 -4","color":"aqua"},{"text":"，","color":"gray"},{"text":"民生 -2","color":"red"}]
