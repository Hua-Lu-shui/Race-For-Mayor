...
execute if score @s decision_task matches 112 run tellraw @s [{"text":"你选择了公开全过程说明：","color":"red"},{"text":"名誉 +6","color":"aqua"},{"text":"，","color":"gray"},{"text":"民生 +2","color":"red"},{"text":"，","color":"gray"},{"text":"经济 -4","color":"yellow"}]
