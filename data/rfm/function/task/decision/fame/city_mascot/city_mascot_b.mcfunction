...
execute if score @s decision_task matches 116 run tellraw @s [{"text":"你选择了由本地学生提案公投：","color":"aqua"},{"text":"名誉 +4","color":"aqua"},{"text":"，","color":"gray"},{"text":"民生 +2","color":"red"},{"text":"，","color":"gray"},{"text":"经济 -2","color":"yellow"}]
