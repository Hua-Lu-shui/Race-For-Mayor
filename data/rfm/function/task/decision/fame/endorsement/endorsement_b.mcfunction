...
execute if score @s decision_task matches 108 run tellraw @s [{"text":"你选择了只接受政策交流：","color":"aqua"},{"text":"名誉 +4","color":"aqua"},{"text":"，","color":"gray"},{"text":"经济 +2","color":"yellow"},{"text":"，","color":"gray"},{"text":"民生 -2","color":"red"}]
