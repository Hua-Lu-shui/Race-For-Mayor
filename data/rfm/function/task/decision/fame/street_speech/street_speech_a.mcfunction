execute if score @s decision_task matches 113 run scoreboard players add @s fame 5
...
execute if score @s decision_task matches 113 run tellraw @s {"text":"你选择了组织大型街头演讲：名誉 +5，民生 +1，经济 -2","color":"yellow"}
