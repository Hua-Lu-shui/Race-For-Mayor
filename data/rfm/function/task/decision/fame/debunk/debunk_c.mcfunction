...
execute if score @s decision_task matches 110 run tellraw @s [{"text":"你选择了只做简短声明：","color":"green"},{"text":"经济 +2","color":"yellow"},{"text":"，","color":"gray"},{"text":"名誉 -2","color":"aqua"},{"text":"，","color":"gray"},{"text":"民生 -2","color":"red"}]
