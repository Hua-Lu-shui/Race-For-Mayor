...
execute if score @s item_held matches 13..24 run tellraw @s {"text":"已选择：属性取舍","color":"gold","bold":true}
execute if score @s item_held matches 25 run tellraw @s {"text":"已选择：名誉专精","color":"aqua","bold":true}
execute if score @s item_held matches 26 run tellraw @s {"text":"已选择：经济专精","color":"yellow","bold":true}
execute if score @s item_held matches 27 run tellraw @s {"text":"已选择：民生专精","color":"red","bold":true}
execute if score @s item_held matches 28 run tellraw @s {"text":"已选择：生态专精","color":"green","bold":true}
...
execute if score @s item_held matches 25 run scoreboard players set #item_25 item_available 0
execute if score @s item_held matches 26 run scoreboard players set #item_26 item_available 0
execute if score @s item_held matches 27 run scoreboard players set #item_27 item_available 0
execute if score @s item_held matches 28 run scoreboard players set #item_28 item_available 0
