...
#第三排：四件属性锁定与四件属性窥探令牌
setblock 1227 -54 90 minecraft:dark_oak_wall_sign[facing=south]{is_waxed:1b,front_text:{messages:['{"text":"属性锁定","color":"light_purple","bold":true}','{"text":"锁定名誉","color":"aqua"}','{"text":"本局不再变化","color":"gray"}','{"text":"[右键选择]","color":"green","clickEvent":{"action":"run_command","value":"/trigger item_pick set 17"}}']}}
setblock 1229 -54 90 minecraft:dark_oak_wall_sign[facing=south]{is_waxed:1b,front_text:{messages:['{"text":"属性锁定","color":"light_purple","bold":true}','{"text":"锁定经济","color":"yellow"}','{"text":"本局不再变化","color":"gray"}','{"text":"[右键选择]","color":"green","clickEvent":{"action":"run_command","value":"/trigger item_pick set 18"}}']}}
setblock 1231 -54 90 minecraft:dark_oak_wall_sign[facing=south]{is_waxed:1b,front_text:{messages:['{"text":"属性锁定","color":"light_purple","bold":true}','{"text":"锁定民生","color":"red"}','{"text":"本局不再变化","color":"gray"}','{"text":"[右键选择]","color":"green","clickEvent":{"action":"run_command","value":"/trigger item_pick set 19"}}']}}
setblock 1233 -54 90 minecraft:dark_oak_wall_sign[facing=south]{is_waxed:1b,front_text:{messages:['{"text":"属性锁定","color":"light_purple","bold":true}','{"text":"锁定生态","color":"green"}','{"text":"本局不再变化","color":"gray"}','{"text":"[右键选择]","color":"green","clickEvent":{"action":"run_command","value":"/trigger item_pick set 20"}}']}}
