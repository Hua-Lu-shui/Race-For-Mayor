...
execute if score @s item_held matches 1..16 run return run function rfm:item/select/skip
execute if score @s item_held matches 21..24 run return run function rfm:item/select/skip
