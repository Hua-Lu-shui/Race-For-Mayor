...
execute as @a[scores={item_selecting=1,item_pick=4}] if score #item_4 item_available matches 1 run scoreboard players set @s item_held 4
execute as @a[scores={item_selecting=1,item_pick=5}] if score #item_5 item_available matches 1 run scoreboard players set @s item_held 5
execute as @a[scores={item_selecting=1,item_pick=6}] if score #item_6 item_available matches 1 run scoreboard players set @s item_held 6
execute as @a[scores={item_selecting=1,item_pick=7}] if score #item_7 item_available matches 1 run scoreboard players set @s item_held 7
execute as @a[scores={item_selecting=1,item_pick=8}] if score #item_8 item_available matches 1 run scoreboard players set @s item_held 8
execute as @a[scores={item_selecting=1,item_pick=9}] if score #item_9 item_available matches 1 run scoreboard players set @s item_held 9
execute as @a[scores={item_selecting=1,item_pick=10}] if score #item_10 item_available matches 1 run scoreboard players set @s item_held 10
execute as @a[scores={item_selecting=1,item_pick=11}] if score #item_11 item_available matches 1 run scoreboard players set @s item_held 11
execute as @a[scores={item_selecting=1,item_pick=12}] if score #item_12 item_available matches 1 run scoreboard players set @s item_held 12
execute as @a[scores={item_selecting=1,item_pick=13}] if score #item_13 item_available matches 1 run scoreboard players set @s item_held 13
