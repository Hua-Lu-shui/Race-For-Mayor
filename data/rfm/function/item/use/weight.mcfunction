...
execute if score #used_item item_held matches 5 run tellraw @a [{"selector":"@s","color":"white","bold":true},{"text":" 使用了【名誉权重加强】；名誉权重实际变化 ","color":"aqua"},{"score":{"name":"@s","objective":"item_delta"},"color":"white","bold":true},{"text":"，当前为 ","color":"aqua"},{"score":{"name":"#weight","objective":"fame_weight"},"color":"white","bold":true},{"text":"。","color":"aqua"}]
execute if score #used_item item_held matches 6 run tellraw @a [{"selector":"@s","color":"white","bold":true},{"text":" 使用了【经济权重加强】；经济权重实际变化 ","color":"yellow"},{"score":{"name":"@s","objective":"item_delta"},"color":"white","bold":true},{"text":"，当前为 ","color":"yellow"},{"score":{"name":"#weight","objective":"economy_weight"},"color":"white","bold":true},{"text":"。","color":"yellow"}]
execute if score #used_item item_held matches 7 run tellraw @a [{"selector":"@s","color":"white","bold":true},{"text":" 使用了【民生权重加强】；民生权重实际变化 ","color":"red"},{"score":{"name":"@s","objective":"item_delta"},"color":"white","bold":true},{"text":"，当前为 ","color":"red"},{"score":{"name":"#weight","objective":"welfare_weight"},"color":"white","bold":true},{"text":"。","color":"red"}]
execute if score #used_item item_held matches 8 run tellraw @a [{"selector":"@s","color":"white","bold":true},{"text":" 使用了【生态权重加强】；生态权重实际变化 ","color":"green"},{"score":{"name":"@s","objective":"item_delta"},"color":"white","bold":true},{"text":"，当前为 ","color":"green"},{"score":{"name":"#weight","objective":"ecology_weight"},"color":"white","bold":true},{"text":"。","color":"green"}]
execute if score #used_item item_held matches 9 run tellraw @a [{"selector":"@s","color":"white","bold":true},{"text":" 使用了【名誉权重削弱】；名誉权重实际变化 ","color":"aqua"},{"score":{"name":"@s","objective":"item_delta"},"color":"white","bold":true},{"text":"，当前为 ","color":"aqua"},{"score":{"name":"#weight","objective":"fame_weight"},"color":"white","bold":true},{"text":"。","color":"aqua"}]
execute if score #used_item item_held matches 10 run tellraw @a [{"selector":"@s","color":"white","bold":true},{"text":" 使用了【经济权重削弱】；经济权重实际变化 ","color":"yellow"},{"score":{"name":"@s","objective":"item_delta"},"color":"white","bold":true},{"text":"，当前为 ","color":"yellow"},{"score":{"name":"#weight","objective":"economy_weight"},"color":"white","bold":true},{"text":"。","color":"yellow"}]
execute if score #used_item item_held matches 11 run tellraw @a [{"selector":"@s","color":"white","bold":true},{"text":" 使用了【民生权重削弱】；民生权重实际变化 ","color":"red"},{"score":{"name":"@s","objective":"item_delta"},"color":"white","bold":true},{"text":"，当前为 ","color":"red"},{"score":{"name":"#weight","objective":"welfare_weight"},"color":"white","bold":true},{"text":"。","color":"red"}]
execute if score #used_item item_held matches 12 run tellraw @a [{"selector":"@s","color":"white","bold":true},{"text":" 使用了【生态权重削弱】；生态权重实际变化 ","color":"green"},{"score":{"name":"@s","objective":"item_delta"},"color":"white","bold":true},{"text":"，当前为 ","color":"green"},{"score":{"name":"#weight","objective":"ecology_weight"},"color":"white","bold":true},{"text":"。","color":"green"}]
