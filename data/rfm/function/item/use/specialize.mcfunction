...
execute if score #used_item item_held matches 13 run tellraw @a[tag=rfm_participant,tag=rfm_item_user,limit=1] [{"selector":"@a[tag=rfm_participant,tag=rfm_item_user,limit=1]","color":"white","bold":true},{"text":" 使用了【名誉专精】；自身名誉 +5，其余未被保护的候选人名誉降低。","color":"aqua"}]
execute if score #used_item item_held matches 14 run tellraw @a[tag=rfm_participant,tag=rfm_item_user,limit=1] [{"selector":"@a[tag=rfm_participant,tag=rfm_item_user,limit=1]","color":"white","bold":true},{"text":" 使用了【经济专精】；自身经济 +5，其余未被保护的候选人经济降低。","color":"yellow"}]
execute if score #used_item item_held matches 15 run tellraw @a[tag=rfm_participant,tag=rfm_item_user,limit=1] [{"selector":"@a[tag=rfm_participant,tag=rfm_item_user,limit=1]","color":"white","bold":true},{"text":" 使用了【民生专精】；自身民生 +5，其余未被保护的候选人民生降低。","color":"red"}]
execute if score #used_item item_held matches 16 run tellraw @a[tag=rfm_participant,tag=rfm_item_user,limit=1] [{"selector":"@a[tag=rfm_participant,tag=rfm_item_user,limit=1]","color":"white","bold":true},{"text":" 使用了【生态专精】；自身生态 +5，其余未被保护的候选人生态降低。","color":"green"}]
execute if score #used_item item_held matches 13 as @a[tag=rfm_participant,tag=rfm_specialize_affected] run tellraw @s [{"text":"有人使用了","color":"white"},{"text":"【属性专精】","color":"#C6A8FF","bold":true},{"text":"令牌，你的","color":"white"},{"text":"名誉","color":"aqua"},{"text":"降低 ","color":"white"},{"score":{"name":"@s","objective":"item_before"},"color":"red","bold":true},{"text":"。","color":"white"}]
execute if score #used_item item_held matches 14 as @a[tag=rfm_participant,tag=rfm_specialize_affected] run tellraw @s [{"text":"有人使用了","color":"white"},{"text":"【属性专精】","color":"#C6A8FF","bold":true},{"text":"令牌，你的","color":"white"},{"text":"经济","color":"yellow"},{"text":"降低 ","color":"white"},{"score":{"name":"@s","objective":"item_before"},"color":"red","bold":true},{"text":"。","color":"white"}]
execute if score #used_item item_held matches 15 as @a[tag=rfm_participant,tag=rfm_specialize_affected] run tellraw @s [{"text":"有人使用了","color":"white"},{"text":"【属性专精】","color":"#C6A8FF","bold":true},{"text":"令牌，你的","color":"white"},{"text":"民生","color":"red"},{"text":"降低 ","color":"white"},{"score":{"name":"@s","objective":"item_before"},"color":"red","bold":true},{"text":"。","color":"white"}]
execute if score #used_item item_held matches 16 as @a[tag=rfm_participant,tag=rfm_specialize_affected] run tellraw @s [{"text":"有人使用了","color":"white"},{"text":"【属性专精】","color":"#C6A8FF","bold":true},{"text":"令牌，你的","color":"white"},{"text":"生态","color":"green"},{"text":"降低 ","color":"white"},{"score":{"name":"@s","objective":"item_before"},"color":"red","bold":true},{"text":"。","color":"white"}]
execute as @a[tag=rfm_participant,tag=rfm_specialize_affected] run tellraw @a[tag=rfm_participant,tag=rfm_item_user,limit=1] [{"text":"实际影响：","color":"gray"},{"selector":"@s","color":"white"},{"text":" 的对应属性变化 ","color":"gray"},{"score":{"name":"@s","objective":"item_delta"},"color":"red","bold":true}]
execute as @a[tag=rfm_participant,tag=!rfm_item_user,tag=!rfm_specialize_affected] if score @s collection_slot1 matches 10 run tellraw @s [{"text":"【神秘的斗篷】","color":"light_purple","bold":true},{"text":"挡下了属性专精影响。","color":"white"}]
execute as @a[tag=rfm_participant,tag=!rfm_item_user,tag=!rfm_specialize_affected] if score @s collection_slot2 matches 10 run tellraw @s [{"text":"【神秘的斗篷】","color":"light_purple","bold":true},{"text":"挡下了属性专精影响。","color":"white"}]
execute as @a[tag=rfm_participant,tag=!rfm_item_user,tag=!rfm_specialize_affected] if score @s collection_slot3 matches 10 run tellraw @s [{"text":"【神秘的斗篷】","color":"light_purple","bold":true},{"text":"挡下了属性专精影响。","color":"white"}]
tag @a[tag=rfm_participant] remove rfm_specialize_affected
