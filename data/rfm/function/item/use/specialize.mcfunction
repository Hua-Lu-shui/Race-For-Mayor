...
execute as @a[tag=!rfm_item_user] run scoreboard players set @s item_before 0
execute as @a[tag=!rfm_item_user] run scoreboard players operation @s item_before -= @s item_delta
...
execute if score #used_item item_held matches 13 as @a[tag=!rfm_item_user] run tellraw @s [{"text":"有人使用了","color":"white"},{"text":"【属性专精】","color":"#C6A8FF","bold":true},{"text":"令牌，你的","color":"white"},{"text":"名誉","color":"aqua"},{"text":"降低 ","color":"white"},{"score":{"name":"@s","objective":"item_before"},"color":"red","bold":true},{"text":"。","color":"white"}]
execute if score #used_item item_held matches 14 as @a[tag=!rfm_item_user] run tellraw @s [{"text":"有人使用了","color":"white"},{"text":"【属性专精】","color":"#C6A8FF","bold":true},{"text":"令牌，你的","color":"white"},{"text":"经济","color":"yellow"},{"text":"降低 ","color":"white"},{"score":{"name":"@s","objective":"item_before"},"color":"red","bold":true},{"text":"。","color":"white"}]
execute if score #used_item item_held matches 15 as @a[tag=!rfm_item_user] run tellraw @s [{"text":"有人使用了","color":"white"},{"text":"【属性专精】","color":"#C6A8FF","bold":true},{"text":"令牌，你的","color":"white"},{"text":"民生","color":"red"},{"text":"降低 ","color":"white"},{"score":{"name":"@s","objective":"item_before"},"color":"red","bold":true},{"text":"。","color":"white"}]
execute if score #used_item item_held matches 16 as @a[tag=!rfm_item_user] run tellraw @s [{"text":"有人使用了","color":"white"},{"text":"【属性专精】","color":"#C6A8FF","bold":true},{"text":"令牌，你的","color":"white"},{"text":"生态","color":"green"},{"text":"降低 ","color":"white"},{"score":{"name":"@s","objective":"item_before"},"color":"red","bold":true},{"text":"。","color":"white"}]
