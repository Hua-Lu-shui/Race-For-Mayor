...
execute if score #used_item item_held matches 13 run tellraw @a [{"selector":"@a[tag=rfm_item_user,limit=1]","color":"white","bold":true},{"text":" 使用了【名誉专精】；自身名誉 +5，其余所有候选人名誉降低。","color":"aqua"}]
execute if score #used_item item_held matches 14 run tellraw @a [{"selector":"@a[tag=rfm_item_user,limit=1]","color":"white","bold":true},{"text":" 使用了【经济专精】；自身经济 +5，其余所有候选人经济降低。","color":"yellow"}]
execute if score #used_item item_held matches 15 run tellraw @a [{"selector":"@a[tag=rfm_item_user,limit=1]","color":"white","bold":true},{"text":" 使用了【民生专精】；自身民生 +5，其余所有候选人民生降低。","color":"red"}]
execute if score #used_item item_held matches 16 run tellraw @a [{"selector":"@a[tag=rfm_item_user,limit=1]","color":"white","bold":true},{"text":" 使用了【生态专精】；自身生态 +5，其余所有候选人生态降低。","color":"green"}]
