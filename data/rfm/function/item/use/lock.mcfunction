...
execute if score #used_item item_held matches 17 run tellraw @s [{"selector":"@s","color":"white","bold":true},{"text":" 使用了【名誉锁定】；其名誉固定为 ","color":"aqua"},{"score":{"name":"@s","objective":"fame_locked"},"color":"black","bold":true},{"text":"。","color":"aqua"}]
execute if score #used_item item_held matches 18 run tellraw @s [{"selector":"@s","color":"white","bold":true},{"text":" 使用了【经济锁定】；其经济固定为 ","color":"yellow"},{"score":{"name":"@s","objective":"economy_locked"},"color":"black","bold":true},{"text":"。","color":"yellow"}]
execute if score #used_item item_held matches 19 run tellraw @s [{"selector":"@s","color":"white","bold":true},{"text":" 使用了【民生锁定】；其民生固定为 ","color":"red"},{"score":{"name":"@s","objective":"welfare_locked"},"color":"black","bold":true},{"text":"。","color":"red"}]
execute if score #used_item item_held matches 20 run tellraw @s [{"selector":"@s","color":"white","bold":true},{"text":" 使用了【生态锁定】；其生态固定为 ","color":"green"},{"score":{"name":"@s","objective":"ecology_locked"},"color":"black","bold":true},{"text":"。","color":"green"}]
