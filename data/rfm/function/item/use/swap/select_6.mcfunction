...
execute unless entity @a[tag=rfm_participant,scores={room=6}] run return run tellraw @s {"translate":"rfm.text.1090a1257b90","color":"red"}
execute if entity @a[tag=rfm_participant,scores={room=6,candidate=7}] run return run tellraw @s {"translate":"rfm.text.3670555c6798","color":"light_purple"}
