...
execute if score #used_item item_held matches 1 run tellraw @a[tag=rfm_participant,tag=rfm_item_user,limit=1] [{"selector":"@a[tag=rfm_participant,tag=rfm_item_user,limit=1]","color":"white","bold":true},{"text":" 使用了【名誉互换】，与 ","color":"aqua"},{"selector":"@a[tag=rfm_participant,tag=rfm_item_target,limit=1]","color":"white","bold":true},{"text":" 交换名誉。","color":"aqua"}]
execute if score #used_item item_held matches 2 run tellraw @a[tag=rfm_participant,tag=rfm_item_user,limit=1] [{"selector":"@a[tag=rfm_participant,tag=rfm_item_user,limit=1]","color":"white","bold":true},{"text":" 使用了【经济互换】，与 ","color":"yellow"},{"selector":"@a[tag=rfm_participant,tag=rfm_item_target,limit=1]","color":"white","bold":true},{"text":" 交换经济。","color":"yellow"}]
execute if score #used_item item_held matches 3 run tellraw @a[tag=rfm_participant,tag=rfm_item_user,limit=1] [{"selector":"@a[tag=rfm_participant,tag=rfm_item_user,limit=1]","color":"white","bold":true},{"text":" 使用了【民生互换】，与 ","color":"red"},{"selector":"@a[tag=rfm_participant,tag=rfm_item_target,limit=1]","color":"white","bold":true},{"text":" 交换民生。","color":"red"}]
execute if score #used_item item_held matches 4 run tellraw @a[tag=rfm_participant,tag=rfm_item_user,limit=1] [{"selector":"@a[tag=rfm_participant,tag=rfm_item_user,limit=1]","color":"white","bold":true},{"text":" 使用了【生态互换】，与 ","color":"green"},{"selector":"@a[tag=rfm_participant,tag=rfm_item_target,limit=1]","color":"white","bold":true},{"text":" 交换生态。","color":"green"}]
execute if score #used_item item_held matches 1 run tellraw @a[tag=rfm_participant,tag=rfm_item_target,limit=1] {"text":"一名玩家与你互换了名誉。","color":"aqua"}
execute if score #used_item item_held matches 2 run tellraw @a[tag=rfm_participant,tag=rfm_item_target,limit=1] {"text":"一名玩家与你互换了经济。","color":"yellow"}
execute if score #used_item item_held matches 3 run tellraw @a[tag=rfm_participant,tag=rfm_item_target,limit=1] {"text":"一名玩家与你互换了民生。","color":"red"}
execute if score #used_item item_held matches 4 run tellraw @a[tag=rfm_participant,tag=rfm_item_target,limit=1] {"text":"一名玩家与你互换了生态。","color":"green"}
execute as @a[tag=rfm_participant,tag=rfm_item_user] run tellraw @a[tag=rfm_participant,tag=rfm_item_user,limit=1] [{"text":"实际影响：","color":"gray"},{"selector":"@s","color":"white"},{"text":" 的对应属性变化 ","color":"gray"},{"score":{"name":"@s","objective":"item_delta"},"color":"yellow","bold":true}]
execute as @a[tag=rfm_participant,tag=rfm_item_target] run tellraw @a[tag=rfm_participant,tag=rfm_item_user,limit=1] [{"text":"实际影响：","color":"gray"},{"selector":"@s","color":"white"},{"text":" 的对应属性变化 ","color":"gray"},{"score":{"name":"@s","objective":"item_delta"},"color":"yellow","bold":true}]
