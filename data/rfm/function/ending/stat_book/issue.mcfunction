...
summon minecraft:item ~ ~ ~ {Tags:["rfm_stat_book_pending"],PickupDelay:0s,Item:{id:"minecraft:written_book",count:1,components:{"minecraft:custom_name":'{"translate":"rfm.text.0eb8790634a9","color":"gold","bold":true,"italic":false}',"minecraft:written_book_content":{title:"竞选统计书",author:"市长竞选委员会",generation:0,pages:[{raw:'{"text":""}'}],resolved:0b},"minecraft:custom_data":{rfm_stat_book:1}}}}
