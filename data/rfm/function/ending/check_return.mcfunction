...
execute positioned 49 -56 35 unless entity @s[distance=..6] run scoreboard players set @s ending_return 0
execute positioned 49 -56 35 unless entity @s[distance=..6] run return 0
