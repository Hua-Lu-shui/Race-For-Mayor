...
title @a[tag=rfm_participant] title [{"translate":"rfm.text.8c6af72ef1d6","color":"gold","bold":true},{"score":{"name":"@a[tag=rfm_participant,tag=rfm_settling,limit=1]","objective":"final_votes"},"color":"yellow","bold":true}]
