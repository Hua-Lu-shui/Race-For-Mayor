...
setblock 49 -56 35 minecraft:oak_sign[rotation=8]{is_waxed:1b,front_text:{has_glowing_text:1b,messages:['{"text":"游戏结束","color":"gold","bold":true}','{"text":"返回","color":"green","bold":true,"clickEvent":{"action":"run_command","value":"/function rfm:ending/return_to_spawn"}}','{"text":"点击回到出生点","color":"gray"}','{"text":"并准备下一局","color":"yellow"}']}}
