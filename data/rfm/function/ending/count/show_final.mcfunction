...
scoreboard players operation #shown_fame settle_value = @a[tag=rfm_settling,limit=1] vote_fame
scoreboard players operation #shown_economy settle_value = @a[tag=rfm_settling,limit=1] vote_economy
scoreboard players operation #shown_welfare settle_value = @a[tag=rfm_settling,limit=1] vote_welfare
scoreboard players operation #shown_ecology settle_value = @a[tag=rfm_settling,limit=1] vote_ecology
