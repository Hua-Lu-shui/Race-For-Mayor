...
title @a[tag=rfm_participant] title [{"translate":"rfm.text.bc37da09beea","color":"gold","bold":true},{"score":{"name":"@a[tag=rfm_participant,tag=rfm_settling,limit=1]","objective":"vote_total"},"color":"white","bold":true}]
